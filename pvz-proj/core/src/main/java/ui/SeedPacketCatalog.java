...
public final class SeedPacketCatalog {
    private static final Map<String, String> ALIASES = Map.ofEntries(
            ...
            Map.entry("goo peashooter", "GOOPEASHOOTER"),
            ...
            Map.entry("pea nut", "PEANUT"),
            Map.entry("banana launcher", "BANANA"),
            Map.entry("homing thistle", "HOMINGTHISTLE"),
            Map.entry("guacodile", "GUACODILE"),
